...
updated = "2026-02-23T04:47:18.152238Z"
tags = []
links = []
+++
...
Aligned Tauri API with current logic crate shape. create_new_adr now parses markdown ADRs via logic::get_adr instead of JSON parsing. Added optional assignee/tags inputs to create_new_issue command path to preserve metadata compatibility, and introduced shared get_active_dir helper for consistent active-project command behavior.
