...
updated = "2026-02-23T04:47:18.116903Z"
tags = []
links = []
+++
...
Implemented config-driven status columns in Tauri UI. Added get_project_config command in src-tauri and loaded statuses into App state. Removed hardcoded IssueStatus/STATUS_CONFIG usage from IssueList/NewIssueModal/IssueDetail and now render columns/chips from project config order and colors.
