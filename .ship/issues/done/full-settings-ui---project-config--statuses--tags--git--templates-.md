...
updated = "2026-02-23T05:57:57.602482Z"
tags = []
links = []
+++
...
Implemented substantial Project settings UI with editable project name/description, status CRUD list (id/name/color + add/delete), and git commit-category toggles. Added new Tauri command save_project_config and wired project settings save path end-to-end. Remaining scope for follow-up: tags CRUD, template editors, and drag reorder (blocked on dnd package availability).
