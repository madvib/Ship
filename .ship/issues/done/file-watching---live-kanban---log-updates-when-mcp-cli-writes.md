...
updated = "2026-02-23T04:52:49.554335Z"
tags = []
links = []
+++
...
Implemented live UI refresh for external CLI/MCP writes. Added project watcher lifecycle in Tauri: when active project changes, previous watcher is stopped and new watcher starts. Backend emits ship://issues-changed, ship://log-changed, and ship://config-changed events based on .ship file changes. Frontend now listens to those events and reloads data with 200ms debounce to avoid thrashing.
