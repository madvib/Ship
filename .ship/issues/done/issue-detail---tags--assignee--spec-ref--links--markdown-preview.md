...
updated = "2026-02-23T04:55:24.945037Z"
tags = []
links = []
+++
...
Expanded Issue Detail panel to edit assignee, tags, spec reference, and links; added description edit/preview toggle with lightweight markdown rendering; added Escape close and Cmd/Ctrl+S save shortcuts; and implemented 2s debounced autosave while keeping explicit Save. update_issue_by_path now receives the full Issue object from UI save path. Link relationships are encoded in metadata.links as 'type:target' strings to stay compatible with current logic schema. Tag suggestions are sourced from existing project issue tags because ProjectConfig currently does not expose a tags list.
