  ...
  try {
    switch (name) {
      ...
      case 'create_issue':
        ...
        const issuePath = await project.createIssue(args.title, args.description, status);
      ...
      case 'update_issue_status':
        const newPath = await project.moveIssue(args.issueFileName, args.currentStatus, args.newStatus);
      ...
      case 'create_adr':
        const adrStatus = args.status || 'proposed';
