import { ArrowRight, FileCode2, FileStack, FolderGit2, Folders, ScrollText } from 'lucide-react';
import { AdrEntry, IssueEntry, LogEntry, Project, SpecEntry, StatusConfig, getStatusStyles } from '../types';
import {
  ACTIVITY_ROUTE,
  ADRS_ROUTE,
  AppRoutePath,
